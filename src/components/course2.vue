<template>
    <div class="right-a">
        <div class="right-s">
            ...
            <span @click="go" style="color: rgba(153, 153, 153, 1);">课程管理/<span style="color:black;">添加课程</span></span>
        </div>
        <div class="right-t">
    ...
    <div class="header">
        <div class="header-a">
            ...
            <div class="say-u">
                <span>商品限制</span>
                <div>
                    <!-- <input type="radio" v-model="radio">上架状态
                    <input type="radio" v-model="radio">下架状态 -->
