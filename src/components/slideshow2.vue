<template>
    <div class="right-a">
        <div class="right-s">
            ...
            <span @click="go" style="color: rgba(153, 153, 153, 1);">轮播图/
                <span style="color:black;">添加轮播图</span></span>
        </div>
        <div class="right-t">
    ...
    <div class="header">
        <div class="header-a">
            <span style="color: rgba(153, 153, 153, 1);">请输入轮播图相关信息</span>
            <!-- 课程名称 -->
            <div class="say">
                <span>轮播图名称</span>
                <input type="text" v-model="ini" style="margin-left: 20px;height: 30px;" placeholder="请输入录播图名称">
            </div>
            <!-- 上传图片 -->
            <div class="say-a">
                <span>轮播图素材</span>
