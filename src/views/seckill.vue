                ...
                <div class="fight-a">
                    ...
                    <div class="fight-i">
                        ...
                        <select @change="abc" :style="{ 'color': flage ? 'rgba(204, 204, 204, 1)' : 'black' }" name=""
                            id="">
                            <option value="fasle">进行中</option>
                            <option value="true">已下线</option>
                        </select>
                    </div>
                </div>
                <!-- 搜索 /重置/搜索 -->
            ...
            <div class="tab-a">
                <div class="tab-c">
                    ...
                    <div>
                        ...
                        <RouterLink to="/seckill2"><span>添加活动</span></RouterLink>
                    </div>
                </div>
            </div>
            <!-- 表格 -->
                ...
                <div class="tab-y">
                    <div>
                        <el-table ref="multipleTableRef" :data="tableData" style="width: 100%"
                            ...
                            <el-table-column label="活动标题" width="220">
                            ...
                            <!-- <el-table-column property="price" label="活动标题" width="130" /> -->
                            ...
                            <el-table-column property="state" label="开始时间" width="200" />
                            <!-- <el-table-column property="price" label="订单金额" width="130" />
                            <el-table-column property="sales" label="订单状态" width="130" /> -->
                            <el-table-column property="sales" label="结束时间" width="200" />
...
const tableData = [
    {
        ...
        address: "进行中",//图片
        state: '2023/8/1',//是否上线
        price: '轮播图说明文字示例1如果超出十个个字则显…这是说明示例3是说明名称示例4说明名称示例5说明名称示例6说明名称示例7说明名称示例8说明名称示例9说明名称示例10',//价格
        sales: '2023/8/10',//销量
    }
]
</script>
