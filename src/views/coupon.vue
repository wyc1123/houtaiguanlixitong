                ...
                <div class="fight-a">
                    ...
                    <div class="fight-i">
                        ...
                        <select name="" id="">
                            ...
                            <option value="">优惠课程</option>
                            <option value="">秒杀课程</option>
                        </select>
                    </div>
                </div>
                <!-- 搜索 /重置/搜索 -->
            ...
            <div class="tab-a">
                <div class="tab-c">
                    ...
                    <div>
                        ...
                        <RouterLink to="/coupon2"><span>添加优惠卷</span></RouterLink>
                    </div>
                </div>
            </div>
            <!-- 表格 -->
                ...
                <div class="tab-y">
                    <div>
                        <el-table ref="multipleTableRef" :data="tableData" style="width: 100%"
                            ...
                            <el-table-column property="price" label="使用范围" width="130" />
                            <!-- <el-table-column label="封面" width="150">
                                <template #default="scope"><img :src="scope.row.name" alt=""></template>
                            </el-table-column> -->
                            <el-table-column label="使用门槛" width="150">
                                <template #default="scope">
                                    <div style="height: 50px;">
                                        {{ scope.row.address }}
                                    </div>
