            ...
            <div class="tab-a">
                <div class="tab-c">
                    ...
                    <div>
                        ...
                        <RouterLink to="/compile"><span>添加讲师</span></RouterLink>
                    </div>
                </div>
            </div>
            <!-- 表格 -->
                ...
                <div class="tab-y">
                    <div>
                        <el-table ref="multipleTableRef" :data="tableData" style="width: 100%"
                            ...
                            <el-table-column label="讲师名称" width="210">
                                <template #default="scope">{{ scope.row.date }}</template>
                            </el-table-column>
                            <el-table-column label="讲师简介" width="600">
                                <template #default="scope">
                                    <div style="height: 30px;text-overflow: ellipsis;text-align: center; ">
                                        {{ scope.row.name }}
                                    </div>
                                </template>
                            </el-table-column>
                            <!-- <el-table-column property="address" label="手机号" width="160" />
                            <el-table-column property="state" label="付款金额" width="160" />
                            <el-table-column property="price" label="订单数量" width="130" />
                            <el-table-column property="sales" label="付款时间" width="130" />
                            <el-table-column label="账户禁用" width="160">
                                <template #default="scope">
                                    <el-switch v-model="value" size="large" />
                                </template>
                            </el-table-column> -->
                            <el-table-column property="state" label="添加时间" width="200" />
...
const tableData = [
    {
        date: '牛魔王',//编号
        name: '这里是讲师简介内容，超出最大宽度显示这里是讲师简介内容，超出最大宽度显示这里…这里是讲师简介文字示例信息这里是讲师简介内容，超出最大宽度显示这里是讲师简介内容这里是讲师简介内容，超出最大宽度显示这里是讲师简介内容，超出最大宽度显示这里…这里是讲师简介文字示例信息这里是讲师简介内容，超出最大宽度显示这里是讲师简介内容这里是讲师简介内容最大宽度显示这里是讲师简介内容，超出最大宽度显示这里…这里是讲师简介文字示例信息这里是讲师简介内容，超出最大宽度显示这里是讲师简介内容这里是讲师简介内容这里是讲师简介文字示例信息',//名称
        // address: "15911239707",//图片
        state: '2023/7/31',//是否上线
        // price: '7/31',//价格
        // sales: '777',//销量
    }
]
